...
simple_p_init:
.LFB200:
	.file 2 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\communication\\simple_protocol.c"
	.loc 2 24 52
...
.L46:
	...
	movs	r2, #255
	strb	r2, [r3]
	.loc 2 28 16 discriminator 3
	ldrb	r3, [sp, #15]	@ zero_extendqisi2
	adds	r3, r3, #1
	strb	r3, [sp, #15]
.L45:
	.loc 2 28 3 discriminator 1
	ldrb	r3, [sp, #15]	@ zero_extendqisi2
	cmp	r3, #0
	beq	.L46
	.loc 2 31 1
...
.L60:
	...
	cmp	r3, #255
	bne	.L57
	.loc 2 59 36 discriminator 1
	ldrb	r3, [sp, #13]	@ zero_extendqisi2
	cmp	r3, #255
	bne	.L57
	.loc 2 59 58 discriminator 2
	ldrb	r3, [sp, #15]
	strb	r3, [sp, #13]
	b	.L58
.L57:
	...
	b	.L59
.L58:
	.loc 2 58 16 discriminator 2
	ldrb	r3, [sp, #15]	@ zero_extendqisi2
	adds	r3, r3, #1
	strb	r3, [sp, #15]
.L56:
	.loc 2 58 3 discriminator 1
	ldrb	r3, [sp, #15]	@ zero_extendqisi2
	cmp	r3, #0
	beq	.L60
.L59:
...
.Ldebug_macro0:
	...
	.uleb128 0x35
	.uleb128 0x35
	.file 54 "../../../../../../external/freertos/portable/CMSIS/nrf52/portmacro_cmsis.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0x36
	.byte	0x3
...
.LASF303:
	...
	.ascii	"al\\slam_applicationLeithe\\communication\\simple_p"
	.ascii	"rotocol.c\000"
.LASF15:
