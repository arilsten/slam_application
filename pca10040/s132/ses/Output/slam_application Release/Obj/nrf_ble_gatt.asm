...
.LCFI3:
	...
	cmp	r3, #0
	beq	.L82
	.loc 6 92 231 discriminator 2
	ldr	r3, .L86
	ldrh	r3, [r3]
	.loc 6 92 242 discriminator 2
	lsls	r3, r3, #16
	.loc 6 92 189 discriminator 2
	orr	r3, r3, #1
	.loc 6 92 140 discriminator 2
	mov	r5, r3
	ldrh	r4, [sp, #6]
	.loc 6 92 363 discriminator 2
	ldr	r0, [sp, #28]
	bl	nrf_strerror_get
	mov	r3, r0
	.loc 6 92 140 discriminator 2
	...
	.loc 6 95 18 discriminator 2
	ldrh	r3, [sp, #12]
	.loc 6 95 12 discriminator 2
	cmp	r3, #0
	bne	.L83
	.loc 6 96 20
	ldrh	r3, [sp, #14]
	...
	beq	.L84
.L83:
	.loc 6 98 235 discriminator 2
	ldr	r3, .L86
	ldrh	r3, [r3]
	.loc 6 98 246 discriminator 2
	lsls	r3, r3, #16
	.loc 6 98 193 discriminator 2
	orr	r3, r3, #1
	.loc 6 98 144 discriminator 2
	mov	r0, r3
	.loc 6 98 334 discriminator 2
	ldrh	r3, [sp, #12]
	.loc 6 98 144 discriminator 2
	mov	r2, r3
	.loc 6 98 377 discriminator 2
	ldrh	r3, [sp, #14]
	.loc 6 98 144 discriminator 2
	ldr	r1, .L86+8
	bl	nrf_log_frontend_std_2
.L84:
	...
	cmp	r3, #0
	beq	.L82
	.loc 6 104 235 discriminator 2
	ldr	r3, .L86
	ldrh	r3, [r3]
	.loc 6 104 246 discriminator 2
	lsls	r3, r3, #16
	.loc 6 104 193 discriminator 2
	orr	r3, r3, #1
	.loc 6 104 144 discriminator 2
	mov	r0, r3
	.loc 6 104 360 discriminator 2
	ldrh	r3, [sp, #16]
	.loc 6 104 144 discriminator 2
	mov	r2, r3
	ldr	r1, .L86+12
...
.L87:
	.align	2
.L86:
	.word	m_nrf_log_nrf_ble_gatt_logs_data_dynamic
	.word	.LC1
	.word	.LC2
	.word	.LC3
.LFE223:
...
.L94:
	...
	b	.L93
.L95:
	.loc 6 170 235 discriminator 2
	ldr	r3, .L98
	ldrh	r3, [r3]
	.loc 6 170 246 discriminator 2
	lsls	r3, r3, #16
	.loc 6 170 193 discriminator 2
	orr	r3, r3, #1
	.loc 6 170 144 discriminator 2
	mov	r4, r3
	.loc 6 170 317 discriminator 2
	ldr	r0, [sp, #16]
	bl	nrf_strerror_get
	mov	r3, r0
	.loc 6 170 144 discriminator 2
...
.LCFI12:
	...
	cmp	r3, #0
	beq	.L102
	.loc 6 218 48 discriminator 1
	ldr	r3, [sp, #16]
	ldrb	r3, [r3, #5]	@ zero_extendqisi2
	.loc 6 218 38 discriminator 1
	cmp	r3, #0
	beq	.L102
.LBB2:
	.loc 6 220 34
...
.LCFI15:
	...
	cmp	r3, #0
	beq	.L104
	.loc 6 262 231 discriminator 2
	ldr	r3, .L108
	ldrh	r3, [r3]
	.loc 6 262 242 discriminator 2
	lsls	r3, r3, #16
	.loc 6 262 189 discriminator 2
	orr	r3, r3, #1
	.loc 6 262 140 discriminator 2
	mov	r4, r3
	.loc 6 262 311 discriminator 2
	ldr	r0, [sp, #28]
	bl	nrf_strerror_get
	mov	r3, r0
	.loc 6 262 140 discriminator 2
...
.L159:
	...
	cmp	r3, #17
	beq	.L146
	.loc 6 544 235 discriminator 2
	ldr	r3, .L162
	ldrh	r3, [r3]
	.loc 6 544 246 discriminator 2
	lsls	r3, r3, #16
	.loc 6 544 193 discriminator 2
	orr	r3, r3, #1
	.loc 6 544 144 discriminator 2
	mov	r4, r3
	.loc 6 544 317 discriminator 2
	ldr	r0, [sp, #12]
	bl	nrf_strerror_get
	mov	r3, r0
	.loc 6 544 144 discriminator 2
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 42 "../../../../../../components/libraries/experimental_log/nrf_log.h"
	.byte	0x3
	.uleb128 0x2f
	.uleb128 0x2a
	.file 43 "../../../../../../components/libraries/experimental_section_vars/nrf_section.h"
	.byte	0x3
	.uleb128 0x35
	.uleb128 0x2b
	.byte	0x3
