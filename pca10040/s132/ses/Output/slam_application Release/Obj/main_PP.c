...
IMU_reading_t IMU_getGyro();
IMU_reading_t IMU_getAccel();
# 44 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\main.c" 2
...
# 81 "../../../drivers/oled.h"
                     invert);
# 7 "../../../drivers/display.h" 2

# 1 "../../../../../../external/freertos/source/include/queue.h" 1
# 9 "../../../drivers/display.h" 2
...
# 28 "../../../drivers/display.h" 3 4
_Bool 
# 28 "../../../drivers/display.h"
     wrap;
...
# 41 "../../../drivers/display.h" 3 4
_Bool 
# 41 "../../../drivers/display.h"
     fill;
...
# 47 "../../../drivers/display.h" 3 4
_Bool 
# 47 "../../../drivers/display.h"
     fill;
        int color;
...
# 34 "../../../drivers/ir.h"
void ir_init(IR_Resolution_t resolution);
# 43 "../../../drivers/ir.h"
...
int *preparePoseMessage(uint16_t x, uint16_t y, uint16_t theta, uint8_t servoAngle, uint16_t* sensorData);
...
static TaskHandle_t handle_display_task,
    handle_user_task,
    handle_microsd_task,
    pose_estimator_task,
...
# 161 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\main.c" 3 4
           0
# 161 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\main.c"
           )); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0)
                                                                                        ;
        ...
        case DISPLAY_POINT:
            ...
            break;
        case DISPLAY_LINE:
            do { const uint32_t LOCAL_ERR_CODE = (nrf_gfx_line_draw( &m_nrf_lcd, &display_operation.element.line.line, 1)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0)
                                                                     ;
            write.content = "Line drawn.";
            break;
        case DISPLAY_CIRCLE:
            do { const uint32_t LOCAL_ERR_CODE = (nrf_gfx_circle_draw( &m_nrf_lcd, &display_operation.element.circle.circle, 1, display_operation.element.circle.fill)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0)

                                                          ;
            write.content = "Circle.";
            break;
        case DISPLAY_RECTANGLE:
            do { const uint32_t LOCAL_ERR_CODE = (nrf_gfx_rect_draw( &m_nrf_lcd, &display_operation.element.rectangle.rectangle, display_operation.element.rectangle.thickness, display_operation.element.rectangle.color, display_operation.element.rectangle.fill)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0)
...
# 452 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\main.c"
    ...
    for (;;) {
        ...
        do { app_error_handler_bare((((0x0) + 15))); } while (0);
    }
}
