...
# 890 "../../../../../../modules/nrfx/hal/nrf_power.h"
                                              enabled, nrf_power_pof_thr_t thr)
{
    if (0) { if (thr == (thr & ((0xFUL << (1UL)) >> (1UL)))) { } else { assert_nrf_callback((uint16_t)892, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_power.h"); } };
...
static inline void nrf_power_rampower_mask_on(uint8_t block, uint32_t section_mask)
{
    if (0) { if (block < (sizeof(((NRF_POWER_Type *) 0x40000000UL)->RAM) / sizeof((((NRF_POWER_Type *) 0x40000000UL)->RAM)[0]))) { } else { assert_nrf_callback((uint16_t)990, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_power.h"); } };
    ((NRF_POWER_Type *) 0x40000000UL)->RAM[block].POWERSET = section_mask;
}

static inline void nrf_power_rampower_mask_off(uint8_t block, uint32_t section_mask)
{
    if (0) { if (block < (sizeof(((NRF_POWER_Type *) 0x40000000UL)->RAM) / sizeof((((NRF_POWER_Type *) 0x40000000UL)->RAM)[0]))) { } else { assert_nrf_callback((uint16_t)996, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_power.h"); } };
    ((NRF_POWER_Type *) 0x40000000UL)->RAM[block].POWERCLR = section_mask;
}

static inline uint32_t nrf_power_rampower_mask_get(uint8_t block)
{
    if (0) { if (block < (sizeof(((NRF_POWER_Type *) 0x40000000UL)->RAM) / sizeof((((NRF_POWER_Type *) 0x40000000UL)->RAM)[0]))) { } else { assert_nrf_callback((uint16_t)1002, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_power.h"); } };
