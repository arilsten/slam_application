...
static inline void nrf_pwm_configure(NRF_PWM_Type * p_reg,
                                       ...
                                       uint16_t top_value)
{
    if (0) { if (top_value <= (0x7FFFUL << (0UL))) { } else { assert_nrf_callback((uint16_t)615, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
...
static inline void nrf_pwm_seq_ptr_set(NRF_PWM_Type * p_reg,
                                         ...
                                         uint16_t const * p_values)
{
    if (0) { if (seq_id <= 1) { } else { assert_nrf_callback((uint16_t)638, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
    if (0) { if (p_values != 
...
static inline void nrf_pwm_seq_cnt_set(NRF_PWM_Type * p_reg,
                                         ...
                                         uint16_t length)
{
    if (0) { if (seq_id <= 1) { } else { assert_nrf_callback((uint16_t)647, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
    if (0) { if (length != 0) { } else { assert_nrf_callback((uint16_t)648, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
    if (0) { if (length <= (0x7FFFUL << (0UL))) { } else { assert_nrf_callback((uint16_t)649, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
...
static inline void nrf_pwm_seq_refresh_set(NRF_PWM_Type * p_reg,
                                             ...
                                             uint32_t refresh)
{
    if (0) { if (seq_id <= 1) { } else { assert_nrf_callback((uint16_t)657, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
    if (0) { if (refresh <= (0xFFFFFFUL << (0UL))) { } else { assert_nrf_callback((uint16_t)658, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
...
static inline void nrf_pwm_seq_end_delay_set(NRF_PWM_Type * p_reg,
                                               ...
                                               uint32_t end_delay)
{
    if (0) { if (seq_id <= 1) { } else { assert_nrf_callback((uint16_t)666, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
    if (0) { if (end_delay <= (0xFFFFFFUL << (0UL))) { } else { assert_nrf_callback((uint16_t)667, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_pwm.h"); } };
...
nrfx_err_t nrfx_pwm_init(nrfx_pwm_t const * const p_instance,
                         ...
                         nrfx_pwm_handler_t handler)
{
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)128, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
...
{
    pwm_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)188, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
...
{
    pwm_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)282, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
    if (0) { if (playback_count > 0) { } else { assert_nrf_callback((uint16_t)283, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
    if (0) { if (nrfx_is_in_ram(p_sequence->values.p_raw)) { } else { assert_nrf_callback((uint16_t)284, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
...
{
    pwm_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)328, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
    if (0) { if (playback_count > 0) { } else { assert_nrf_callback((uint16_t)329, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
    if (0) { if (nrfx_is_in_ram(p_sequence_0->values.p_raw)) { } else { assert_nrf_callback((uint16_t)330, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
    if (0) { if (nrfx_is_in_ram(p_sequence_1->values.p_raw)) { } else { assert_nrf_callback((uint16_t)331, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
...
# 369 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"
                       wait_until_stopped)
{
    if (0) { if (m_cb[p_instance->drv_inst_idx].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)371, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
...
{
    pwm_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)400, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_pwm.c"); } };
