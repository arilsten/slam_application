...
.LCFI4:
	...
	cmp	r3, #0
	beq	.L59
	.loc 2 294 98 discriminator 1
	ldr	r1, [sp, #4]
	.loc 2 294 159 discriminator 1
	ldr	r3, [sp, #8]
	ldr	r3, [r3, #4]
	.loc 2 294 151 discriminator 1
	rsbs	r3, r3, #0
	.loc 2 294 98 discriminator 1
	mov	r2, r3
	movs	r0, #57
...
.LCFI8:
	...
	b	.L77
.L78:
	.loc 2 385 87 discriminator 3
	ldr	r3, [sp, #12]
	ldr	r3, [r3]
	str	r3, [sp, #12]
.L77:
	.loc 2 385 39 discriminator 1
	ldr	r3, [sp, #12]
	ldr	r3, [r3]
	.loc 2 385 2 discriminator 1
	ldr	r2, [sp, #4]
	cmp	r2, r3
	bhi	.L78
	.loc 2 392 6
