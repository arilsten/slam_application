...
# 396 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
  ...
  {
   if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) { switch (ucQueueType) { case ( ( uint8_t ) 0U ): prvTraceStoreEvent2(0x41, 0, uxQueueLength); break; case ( ( uint8_t ) 3U ): prvTraceStoreEvent1(0x42, 0); break; case ( ( uint8_t ) 1U ): prvTraceStoreEvent1(0x43, 0); break; case ( ( uint8_t ) 4U ): prvTraceStoreEvent1(0x47, 0); break; } };
  }
...
# 709 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
                     )
  {
   ...
   prvTraceSetQueueNumberHigh16((void*)xHandle, CurrentFilterGroup); if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) if (prvTraceGetQueueNumberHigh16((void*)xHandle) & CurrentFilterMask) prvTraceStoreEvent2(0x16, (uint32_t)xHandle, uxMaxCount);
  }
  else
  {
   if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) prvTraceStoreEvent2(0x46, 0, uxMaxCount);;
  }
...
# 808 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
  ...
  if( xTaskCheckForTimeOut( &xTimeOut, &xTicksToWait ) == ( ( BaseType_t ) 0 ) )
  {
   ...
   {
    if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) if (prvTraceGetQueueNumberHigh16((void*)pxQueue) & CurrentFilterMask) switch (pxQueue->ucQueueType) { case ( ( uint8_t ) 0U ): prvTraceStoreEvent2(xCopyPosition == ( ( BaseType_t ) 0 ) ? 0x56 : 0xC2, (uint32_t)pxQueue, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 3U ): case ( ( uint8_t ) 2U ): prvTraceStoreEvent2(0x57, (uint32_t)pxQueue, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 1U ): case ( ( uint8_t ) 4U ): prvTraceStoreEvent1(0x58, (uint32_t)pxQueue); break; };
...
BaseType_t MyWrapper(QueueHandle_t xQueue, BaseType_t * const pxHigherPriorityTaskWoken, const BaseType_t xCopyPosition); BaseType_t xQueueGiveFromISR(QueueHandle_t xQueue, BaseType_t * const pxHigherPriorityTaskWoken) { return MyWrapper(xQueue, pxHigherPriorityTaskWoken, ( ( BaseType_t ) 0 )); } BaseType_t MyWrapper(QueueHandle_t xQueue, BaseType_t * const pxHigherPriorityTaskWoken, const BaseType_t xCopyPosition)
{
BaseType_t xReturn;
UBaseType_t uxSavedInterruptStatus;
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 for( ;; )
 {
  ...
  if( xTaskCheckForTimeOut( &xTimeOut, &xTicksToWait ) == ( ( BaseType_t ) 0 ) )
  {
   ...
   {
    if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) if (prvTraceGetQueueNumberHigh16((void*)pxQueue) & CurrentFilterMask) switch (pxQueue->ucQueueType) { case ( ( uint8_t ) 0U ): prvTraceStoreEvent3((1341 < 0) ? 0x76 : 0x66, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 3U ): case ( ( uint8_t ) 2U ): prvTraceStoreEvent3((1341 < 0) ? 0x77 : 0x67, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 1U ): case ( ( uint8_t ) 4U ): prvTraceStoreEvent2((1341 < 0) ? 0x78 : 0x68, (uint32_t)pxQueue, xTicksToWait); break; };
...
# 1431 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\queue.c"
  ...
  if( xTaskCheckForTimeOut( &xTimeOut, &xTicksToWait ) == ( ( BaseType_t ) 0 ) )
  {
   ...
   if( prvIsQueueEmpty( pxQueue ) != ( ( BaseType_t ) 0 ) )
   {
    if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) if (prvTraceGetQueueNumberHigh16((void*)pxQueue) & CurrentFilterMask) switch (pxQueue->ucQueueType) { case ( ( uint8_t ) 0U ): prvTraceStoreEvent3((1515 < 0) ? 0x76 : 0x66, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 3U ): case ( ( uint8_t ) 2U ): prvTraceStoreEvent3((1515 < 0) ? 0x77 : 0x67, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 1U ): case ( ( uint8_t ) 4U ): prvTraceStoreEvent2((1515 < 0) ? 0x78 : 0x68, (uint32_t)pxQueue, xTicksToWait); break; };
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 for( ;; )
 {
  vPortEnterCritical();
  {
   ...
   else
   {
    if( xTicksToWait == ( TickType_t ) 0 )
    {
     ...
     vPortExitCritical();
     if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) if (prvTraceGetQueueNumberHigh16((void*)pxQueue) & CurrentFilterMask) switch (pxQueue->ucQueueType) { case ( ( uint8_t ) 0U ): prvTraceStoreEvent3(0x73, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 3U ): case ( ( uint8_t ) 2U ): prvTraceStoreEvent3(0x74, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 1U ): case ( ( uint8_t ) 4U ): prvTraceStoreEvent2(0x75, (uint32_t)pxQueue, xTicksToWait); break; };
     return ( ( BaseType_t ) 0 );
    }
    else if( xEntryTimeSet == ( ( BaseType_t ) 0 ) )
    {
  ...
  if( xTaskCheckForTimeOut( &xTimeOut, &xTicksToWait ) == ( ( BaseType_t ) 0 ) )
  {
   ...
   if( prvIsQueueEmpty( pxQueue ) != ( ( BaseType_t ) 0 ) )
   {
    if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) if (prvTraceGetQueueNumberHigh16((void*)pxQueue) & CurrentFilterMask) switch (pxQueue->ucQueueType) { case ( ( uint8_t ) 0U ): prvTraceStoreEvent3(0x76, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 3U ): case ( ( uint8_t ) 2U ): prvTraceStoreEvent3(0x77, (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting); break; case ( ( uint8_t ) 1U ): case ( ( uint8_t ) 4U ): prvTraceStoreEvent2(0x78, (uint32_t)pxQueue, xTicksToWait); break; };
    vTaskPlaceOnEventList( &( pxQueue->xTasksWaitingToReceive ), xTicksToWait );
    prvUnlockQueue( pxQueue );
    if( xTaskResumeAll() == ( ( BaseType_t ) 0 ) )
    {
