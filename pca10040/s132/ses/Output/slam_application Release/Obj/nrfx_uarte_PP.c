...
nrfx_err_t nrfx_uarte_init(nrfx_uarte_t const * p_instance,
                           ...
                           nrfx_uarte_event_handler_t event_handler)
{
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)188, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
...
{
    uarte_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)269, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (0) { if (p_data) { } else { assert_nrf_callback((uint16_t)270, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (0) { if (length > 0) { } else { assert_nrf_callback((uint16_t)271, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (0) { if (((((p_instance->drv_inst_idx) == NRFX_UARTE0_INST_IDX) && (((length) < (1U << 8)) && ((0) < (1U << 8)))) || 0)) { } else { assert_nrf_callback((uint16_t)272, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
                         ...
                         size_t length)
{
    ...
    if (0) { if (m_cb[p_instance->drv_inst_idx].state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)343, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (0) { if (p_data) { } else { assert_nrf_callback((uint16_t)344, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (0) { if (length > 0) { } else { assert_nrf_callback((uint16_t)345, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (0) { if (((((p_instance->drv_inst_idx) == NRFX_UARTE0_INST_IDX) && (((length) < (1U << 8)) && ((0) < (1U << 8)))) || 0)) { } else { assert_nrf_callback((uint16_t)346, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
