...
uint32_t app_button_enable(void)
{
    if (0) { if (mp_buttons) { } else { assert_nrf_callback((uint16_t)186, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\button\\app_button.c"); } };
...
uint32_t app_button_disable(void)
{
    if (0) { if (mp_buttons) { } else { assert_nrf_callback((uint16_t)200, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\button\\app_button.c"); } };
...
# 213 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\button\\app_button.c"
    app_button_is_pushed(uint8_t button_id)
{
    if (0) { if (button_id <= m_button_count) { } else { assert_nrf_callback((uint16_t)215, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\button\\app_button.c"); } };
    if (0) { if (mp_buttons != 
# 216 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\button\\app_button.c" 3 4
   0
# 216 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\button\\app_button.c"
