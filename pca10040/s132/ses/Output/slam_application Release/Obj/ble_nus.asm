...
.LCFI1:
	...
	cmp	r3, #0
	bne	.L83
	.loc 6 100 15 discriminator 1
	ldr	r3, [sp, #4]
	ldr	r3, [r3, #24]
	.loc 6 99 35 discriminator 1
	cmp	r3, #0
	beq	.L83
	.loc 6 101 50
	ldr	r3, [sp, #24]
...
.L85:
	...
	cmp	r2, r3
	bne	.L91
	.loc 6 169 20 discriminator 1
	ldr	r3, [sp, #4]
	ldr	r3, [r3, #24]
	.loc 6 168 70 discriminator 1
	cmp	r3, #0
	beq	.L91
	.loc 6 171 18
	movs	r3, #0
...
.LBE6:
	...
	cmp	r3, r2
	beq	.L126
	.loc 6 414 46 discriminator 1
	ldr	r3, [sp, #20]
	.loc 6 414 33 discriminator 1
	cmp	r3, #0
	bne	.L127
.L126:
	.loc 6 416 16
...
.Letext0:
	...
	.4byte	.LASF7
	.byte	0
	.file 10 "../../../../../../components/ble/ble_link_ctx_manager/ble_link_ctx_manager.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x2b
	.uleb128 0x9
	.file 43 "../../../../../../components/ble/common/ble_srv_common.h"
	.byte	0x3
	.uleb128 0x46
	.uleb128 0x2b
	.byte	0x3
