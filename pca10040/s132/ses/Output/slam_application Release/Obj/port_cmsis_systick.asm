...
.LFE199:
	...
	.section	.text.nrf_rtc_int_enable,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	nrf_rtc_int_enable, %function
nrf_rtc_int_enable:
.LFB215:
	.file 5 "../../../../../../modules/nrfx/hal/nrf_rtc.h"
	.loc 5 251 1
	@ args = 0, pretend = 0, frame = 8
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
...
.LCFI7:
	...
	bx	lr
.LFE215:
	.size	nrf_rtc_int_enable, .-nrf_rtc_int_enable
	.section	.text.nrf_rtc_event_clear,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	nrf_rtc_event_clear, %function
nrf_rtc_event_clear:
.LFB220:
	.loc 5 276 1
	@ args = 0, pretend = 0, frame = 16
...
.LCFI9:
	...
	bx	lr
.LFE220:
	.size	nrf_rtc_event_clear, .-nrf_rtc_event_clear
	.section	.text.nrf_rtc_counter_get,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	nrf_rtc_counter_get, %function
nrf_rtc_counter_get:
.LFB221:
	.loc 5 285 1
	@ args = 0, pretend = 0, frame = 8
...
.LCFI11:
	...
	bx	lr
.LFE221:
	.size	nrf_rtc_counter_get, .-nrf_rtc_counter_get
	.section	.text.nrf_rtc_prescaler_set,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	nrf_rtc_prescaler_set, %function
...
.LCFI13:
	...
	bx	lr
.LFE222:
	.size	nrf_rtc_prescaler_set, .-nrf_rtc_prescaler_set
	.section	.text.nrf_rtc_task_trigger,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	nrf_rtc_task_trigger, %function
...
.LCFI15:
	...
	bx	lr
.LFE226:
	.size	nrf_rtc_task_trigger, .-nrf_rtc_task_trigger
	.section	.text.nrf_rtc_event_enable,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	nrf_rtc_event_enable, %function
...
.LCFI17:
	...
	bx	lr
.LFE227:
	.size	nrf_rtc_event_enable, .-nrf_rtc_event_enable
...
.LCFI19:
	...
	.loc 6 124 32
	ldr	r0, .L68
	bl	nrf_rtc_counter_get
	str	r0, [sp, #8]
	.loc 6 125 5
	mov	r1, #256
	ldr	r0, .L68
	bl	nrf_rtc_event_clear
.LBB15:
	.loc 6 131 35
...
.LCFI21:
	...
	movs	r1, #32
	ldr	r0, .L71
	bl	nrf_rtc_prescaler_set
	.loc 6 172 5
	movs	r1, #1
	ldr	r0, .L71
	bl	nrf_rtc_int_enable
	.loc 6 173 5
	movs	r1, #8
	ldr	r0, .L71
	bl	nrf_rtc_task_trigger
	.loc 6 174 5
	movs	r1, #0
	ldr	r0, .L71
	bl	nrf_rtc_task_trigger
...
.Ldebug_macro0:
	...
	.uleb128 0x1f
	.uleb128 0x38
	.file 57 "../../../../../../external/freertos/source/include/list.h"
	.byte	0x3
	.uleb128 0x25
	.uleb128 0x39
	.byte	0x4
	...
	.byte	0x4
	.byte	0x4
	.file 67 "../../../../../../components/softdevice/common/nrf_sdh.h"
	.byte	0x3
	.uleb128 0x25
	.uleb128 0x43
	.file 68 "../../../../../../components/libraries/experimental_section_vars/nrf_section_iter.h"
	.byte	0x3
	.uleb128 0x37
	.uleb128 0x44
	.byte	0x3
	...
	.uleb128 0x6e
	.uleb128 0x5
	.file 69 "../../../../../../modules/nrfx/nrfx.h"
	.byte	0x3
	.uleb128 0x2c
	.uleb128 0x45
	.file 70 "../../../../../../integration/nrfx/nrfx_config.h"
	.byte	0x3
	.uleb128 0x2c
	.uleb128 0x46
	.byte	0x4
	.file 71 "../../../../../../modules/nrfx/drivers/nrfx_common.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x47
	...
	.byte	0x4
	.byte	0x4
	.file 82 "../../../../../../integration/nrfx/legacy/nrf_drv_clock.h"
	.byte	0x3
	.uleb128 0x6f
	.uleb128 0x52
