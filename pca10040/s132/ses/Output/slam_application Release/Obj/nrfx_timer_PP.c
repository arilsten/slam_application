...
static inline uint32_t nrfx_timer_capture_task_address_get(nrfx_timer_t const * const p_instance,
                                                             uint32_t channel)
{
    if (0) { if (channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)359, (uint8_t *)"../../../../../../modules/nrfx/drivers/include/nrfx_timer.h"); } };
...
static inline uint32_t nrfx_timer_compare_event_address_get(nrfx_timer_t const * const p_instance,
                                                              uint32_t channel)
{
    if (0) { if (channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)373, (uint8_t *)"../../../../../../modules/nrfx/drivers/include/nrfx_timer.h"); } };
                           ...
                           nrfx_timer_event_handler_t timer_event_handler)
{
    ...
    if (0) { if (p_instance->p_reg != ((NRF_TIMER_Type *) 0x40008000UL)) { } else { assert_nrf_callback((uint16_t)72, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };

    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)74, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (0) { if (timer_event_handler) { } else { assert_nrf_callback((uint16_t)75, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
void nrfx_timer_enable(nrfx_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance->instance_id].state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)143, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
void nrfx_timer_disable(nrfx_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)151, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
# 157 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
    nrfx_timer_is_enabled(nrfx_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)159, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    return (m_cb[p_instance->instance_id].state == NRFX_DRV_STATE_POWERED_ON);
}

void nrfx_timer_resume(nrfx_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)165, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_START);
...
void nrfx_timer_pause(nrfx_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)172, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
void nrfx_timer_clear(nrfx_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)179, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_CLEAR);
}

void nrfx_timer_increment(nrfx_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)185, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (0) { if (nrf_timer_mode_get(p_instance->p_reg) != NRF_TIMER_MODE_TIMER) { } else { assert_nrf_callback((uint16_t)186, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
uint32_t nrfx_timer_capture(nrfx_timer_t const * const p_instance,
                            nrf_timer_cc_channel_t cc_channel)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)194, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (0) { if (cc_channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)195, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
void nrfx_timer_compare_int_enable(nrfx_timer_t const * const p_instance,
                                   uint32_t channel)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)251, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (0) { if (channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)252, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
...
void nrfx_timer_compare_int_disable(nrfx_timer_t const * const p_instance,
                                    uint32_t channel)
{
    if (0) { if (m_cb[p_instance->instance_id].state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)263, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
    if (0) { if (channel < p_instance->cc_channel_count) { } else { assert_nrf_callback((uint16_t)264, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"); } };
