...
nrfx_err_t nrfx_spi_init(nrfx_spi_t const * const p_instance,
                         ...
                         void * p_context)
{
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)83, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
...
{
    spi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)205, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
...
{
    spi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)356, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
    if (0) { if (p_xfer_desc->p_tx_buffer != 
# 357 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 3 4
   0 
# 357 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
   || p_xfer_desc->tx_length == 0) { } else { assert_nrf_callback((uint16_t)357, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
    if (0) { if (p_xfer_desc->p_rx_buffer != 
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 3 4
   0 
# 358 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
...
{
    spi_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)403, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
    p_cb->abort = 
# 404 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c" 3 4
                 1
# 404 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"
...
{
    if (0) { if (p_cb->handler) { } else { assert_nrf_callback((uint16_t)409, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_spi.c"); } };
