...

{
    ...
    while (1)
    {
        if (0) { if (block_len) { } else { assert_nrf_callback((uint16_t)400, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
        if (0) { if (m_cb.state.rw_op.block_count) { } else { assert_nrf_callback((uint16_t)401, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
                        ...
                        void * p_context)
{
    ...
    if (m_cb.state.bus_state == SDC_BUS_ACMD || m_cb.state.bus_state == SDC_BUS_CMD)
    {
        ...
        if (0) { if (rx_length > 6) { } else { assert_nrf_callback((uint16_t)855, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
        rx_length -= 6;
        rx_data += 6;
        ...
        if (!rx_data && m_cb.state.op != SDC_OP_RESET)
        {
            ...
            switch (m_cb.state.op)
            {
                ...
                case SDC_OP_IDENTIFICATION:
                    ...
                    do { const uint32_t LOCAL_ERR_CODE = (app_sdc_uninit()); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0);
                    break;
                case SDC_OP_READ:
...
ret_code_t app_sdc_block_read(uint8_t * p_buf, uint32_t block_address, uint16_t block_count)
{
    if (0) { if (p_buf) { } else { assert_nrf_callback((uint16_t)994, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
...
ret_code_t app_sdc_block_write(uint8_t const * p_buf, uint32_t block_address, uint16_t block_count)
{
    if (0) { if (p_buf) { } else { assert_nrf_callback((uint16_t)1034, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } };
...
ret_code_t app_sdc_init(app_sdc_config_t const * const p_config, sdc_event_handler_t event_handler)
{
    ...
    ret_code_t err_code;
    if (0) { if (p_config->cs_pin && p_config->miso_pin && p_config->mosi_pin && p_config->sck_pin) { } else { assert_nrf_callback((uint16_t)1105, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\sdcard\\app_sdcard.c"); } }
                                                      ;
