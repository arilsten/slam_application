...
# 142 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
        ...
        if (memcmp(p_cb->p_current_configuration, p_instance_cfg, sizeof(*p_instance_cfg)) != 0)
        {
            ...
            result = nrf_drv_spi_init(&p_nrf_spi_mngr->spi,
                                      ...
                                      spi_event_handler,
                                      (void *)p_nrf_spi_mngr);
            if (0) { if (result == ((0x0) + 0)) { } else { assert_nrf_callback((uint16_t)160, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"); } };
...
# 193 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
    ...
    if (0) { if (p_cb->p_current_transaction != 
# 199 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c" 3 4
   0
# 199 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
...
# 245 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
    ...
    if (0) { if (p_nrf_spi_mngr->p_queue != 
# 246 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c" 3 4
   0
# 246 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
   ) { } else { assert_nrf_callback((uint16_t)246, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"); } };
    if (0) { if (p_nrf_spi_mngr->p_queue->size > 0) { } else { assert_nrf_callback((uint16_t)247, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"); } };
    if (0) { if (p_default_spi_config != 
# 248 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c" 3 4
   0
# 248 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
...
# 285 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
    ...
    if (0) { if (p_transaction->number_of_transfers != 0) { } else { assert_nrf_callback((uint16_t)286, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"); } };
...
# 315 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"
    ...
    if (0) { if (number_of_transfers != 0) { } else { assert_nrf_callback((uint16_t)316, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\spi_mngr\\nrf_spi_mngr.c"); } };
