...
.LBB2:
	...
	b	.L124
.L125:
	.loc 7 100 23 discriminator 3
	ldr	r3, .L126
	.loc 7 100 9 discriminator 3
	ldr	r0, [sp, #4]
	blx	r3
.LVL0:
	.loc 7 98 85 discriminator 3
	ldr	r3, [sp, #12]
	adds	r3, r3, #1
	str	r3, [sp, #12]
.L124:
	.loc 7 98 5 discriminator 1
	ldr	r3, [sp, #12]
	cmp	r3, #0
	beq	.L125
.LBE2:
...
.L136:
	.align	2
.L135:
	.word	m_flag_params_reply_pending_flash_full
	.word	m_flag_params_reply_pending_busy
	.word	m_flag_link_secure_pending_flash_full
	.word	m_flag_link_secure_pending_busy
.LFE280:
...
.LCFI7:
	...
	cmp	r3, #0
	beq	.L144
	.loc 7 174 35 discriminator 1
	ldr	r3, [sp, #8]
	cmp	r3, #17
	beq	.L144
	.loc 7 174 65 discriminator 2
	ldr	r3, [sp, #8]
	cmp	r3, #8
	beq	.L144
.LBB3:
	...
	b	.L141
.L140:
	.loc 7 186 50 is_stmt 0 discriminator 1
	movs	r3, #2
.L141:
	.loc 7 184 50 is_stmt 1
	strb	r3, [sp, #28]
	.loc 7 187 50
	movs	r3, #0
	strb	r3, [sp, #32]
...
.LBB4:
	...
	cmp	r3, #0
	beq	.L152
	.loc 7 269 42 discriminator 1
	ldrb	r3, [sp, #17]	@ zero_extendqisi2
	.loc 7 269 34 discriminator 1
	eor	r3, r3, #1
	uxtb	r3, r3
	.loc 7 269 31 discriminator 1
	cmp	r3, #0
	beq	.L152
	.loc 7 272 20
	movs	r3, #5
...
.L164:
	.align	2
.L163:
	.word	m_sec_params_set
	.word	m_flag_link_secure_null_params
	.word	m_flag_link_secure_force_repairing
.LFE284:
...
.LFE285:
	...
	.section	.text.params_req_process,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	params_req_process, %function
params_req_process:
.LFB286:
	.loc 7 337 1
...
.LCFI24:
	...
	ldr	pc, [sp], #4
.LFE286:
	.size	params_req_process, .-params_req_process
...
.L208:
	...
	cmp	r3, #0
	beq	.L209
	.loc 7 536 54 discriminator 1
	ldr	r3, [sp, #4]
	ldrb	r3, [r3]	@ zero_extendqisi2
	and	r3, r3, #112
	uxtb	r3, r3
	.loc 7 536 28 discriminator 1
	cmp	r3, #48
	bne	.L209
	.loc 7 536 66 discriminator 2
	ldr	r3, [sp, #4]
	ldrb	r3, [r3]	@ zero_extendqisi2
	bic	r3, r3, #127
	uxtb	r3, r3
	.loc 7 536 63 discriminator 2
	cmp	r3, #0
	bne	.L209
	.loc 7 538 15
	movs	r3, #0
...
.L216:
	...
	cmp	r3, #0
	bne	.L217
	.loc 7 572 34 discriminator 1
	ldr	r3, [sp, #4]
	ldrb	r3, [r3, #3]	@ zero_extendqisi2
	and	r3, r3, #1
	uxtb	r3, r3
	.loc 7 572 29 discriminator 1
	cmp	r3, #0
	bne	.L218
	.loc 7 573 33
	ldr	r3, [sp, #4]
...
.Letext0:
	...
	.4byte	.LASF4
	.byte	0
	.file 8 "../../../../../../components/ble/common/ble_conn_state.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x2c
	.byte	0x4
	.file 46 "../../../../../../components/ble/common/ble_gatt_db.h"
	.byte	0x3
	.uleb128 0x38
	.uleb128 0x2e
	.byte	0x3
