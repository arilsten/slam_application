...
.LFE212:
	...
	.align	2
.LC0:
	.ascii	"Fatal error\000"
	.align	2
.LC1:
	.ascii	"System reset\000"
...
.LBE16:
	...
	nop
.L53:
	.loc 5 58 39 discriminator 2
	bl	nrf_log_frontend_dequeue
	mov	r3, r0
	.loc 5 58 38 discriminator 2
	cmp	r3, #0
	bne	.L53
	.loc 5 61 218 discriminator 2
	ldr	r3, .L55
	ldrh	r3, [r3]
	.loc 5 61 229 discriminator 2
	lsls	r3, r3, #16
	.loc 5 61 185 discriminator 2
	orr	r3, r3, #1
	.loc 5 61 136 discriminator 2
	ldr	r1, .L55+4
	mov	r0, r3
	bl	nrf_log_frontend_std_0
	.loc 5 99 49 discriminator 2
	ldr	r3, .L55+8
	ldr	r3, [r3]
	.loc 5 99 57 discriminator 2
	and	r3, r3, #1
	.loc 5 99 13 discriminator 2
	cmp	r3, #0
	beq	.L54
	.loc 5 99 69 discriminator 1
	.syntax unified
...
@ 0 "" 2
	...
	.syntax unified
.L54:
	.loc 5 103 226 discriminator 2
	ldr	r3, .L55
	ldrh	r3, [r3]
	.loc 5 103 237 discriminator 2
	lsls	r3, r3, #16
	.loc 5 103 193 discriminator 2
	orr	r3, r3, #2
	.loc 5 103 142 discriminator 2
	ldr	r1, .L55+12
	mov	r0, r3
	bl	nrf_log_frontend_std_0
	.loc 5 104 5 discriminator 2
	bl	NVIC_SystemReset
	.loc 5 108 1 discriminator 2
	nop
	add	sp, sp, #20
.LCFI2:
	@ sp needed
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 40 "../../../../../../components/libraries/strerror/nrf_strerror.h"
	.byte	0x3
	.uleb128 0x37
	.uleb128 0x28
	.byte	0x3
	...
	.uleb128 0xc
	.byte	0x4
	.file 41 "../../../../../../components/libraries/experimental_log/nrf_log_instance.h"
	.byte	0x3
	.uleb128 0x30
	.uleb128 0x29
	.byte	0x3
	...
	.byte	0x4
	.byte	0x4
	.file 42 "../../../../../../components/libraries/experimental_log/nrf_log_ctrl.h"
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x2a
	.file 43 "../../../../../../components/libraries/experimental_log/src/nrf_log_ctrl_internal.h"
	.byte	0x3
	.uleb128 0x3a
	.uleb128 0x2b
	.byte	0x4
	.file 44 "../../../../../../components/libraries/experimental_log/nrf_log_backend_interface.h"
	.byte	0x3
	.uleb128 0x3b
	.uleb128 0x2c
	.file 45 "../../../../../../components/libraries/experimental_memobj/nrf_memobj.h"
	.byte	0x3
	.uleb128 0x35
	.uleb128 0x2d
	.file 46 "C:/Program Files (x86)/SEGGER/SEGGER Embedded Studio for ARM 4.50/include/stdlib.h"
	.byte	0x3
	.uleb128 0x33
	.uleb128 0x2e
	.byte	0x4
	.file 47 "../../../../../../components/libraries/balloc/nrf_balloc.h"
	.byte	0x3
	.uleb128 0x35
	.uleb128 0x2f
