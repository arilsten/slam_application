...
nrfx_err_t nrfx_uart_init(nrfx_uart_t const * p_instance,
                          ...
                          nrfx_uart_event_handler_t event_handler)
{
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)170, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
...
{
    uart_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)277, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (0) { if (p_data) { } else { assert_nrf_callback((uint16_t)278, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (0) { if (length > 0) { } else { assert_nrf_callback((uint16_t)279, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
                        ...
                        size_t length)
{
    ...
    if (0) { if (m_cb[p_instance->drv_inst_idx].state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)361, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (0) { if (p_data) { } else { assert_nrf_callback((uint16_t)362, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
    if (0) { if (length > 0) { } else { assert_nrf_callback((uint16_t)363, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"); } };
