...
static inline ret_code_t nrf_blk_dev_init(nrf_block_dev_t const * p_blk_dev,
                                          ...
                                          void const * p_context)
{
    if (0) { if (p_blk_dev->p_ops->init) { } else { assert_nrf_callback((uint16_t)240, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
{
    if (0) { if (p_blk_dev->p_ops->uninit) { } else { assert_nrf_callback((uint16_t)253, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
static inline ret_code_t nrf_blk_dev_read_req(nrf_block_dev_t const * p_blk_dev,
                                              nrf_block_req_t const * p_blk)
{
    if (0) { if (p_blk_dev->p_ops->read_req) { } else { assert_nrf_callback((uint16_t)274, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    if (0) { if (p_blk_dev->p_ops->geometry) { } else { assert_nrf_callback((uint16_t)275, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
static inline ret_code_t nrf_blk_dev_write_req(nrf_block_dev_t const * p_blk_dev,
                                               nrf_block_req_t const * p_blk)
{
    if (0) { if (p_blk_dev->p_ops->write_req) { } else { assert_nrf_callback((uint16_t)302, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
    if (0) { if (p_blk_dev->p_ops->geometry) { } else { assert_nrf_callback((uint16_t)303, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
static inline ret_code_t nrf_blk_dev_ioctl(nrf_block_dev_t const * p_blk_dev,
                                           ...
                                           void * p_data)
{
    if (0) { if (p_blk_dev->p_ops->ioctl) { } else { assert_nrf_callback((uint16_t)326, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
{
    if (0) { if (p_blk_dev->p_ops->geometry) { } else { assert_nrf_callback((uint16_t)340, (uint8_t *)"../../../../../../components/libraries/block_dev/nrf_block_dev.h"); } };
...
# 92 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"
        ...
        default:
            do { const uint32_t LOCAL_ERR_CODE = (((0x0) + 3)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0);
            return;
    }
}
...
static ret_code_t block_dev_sdc_init(nrf_block_dev_t const * p_blk_dev,
                                     ...
                                     void const * p_context)
{
    if (0) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)139, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
...
{
    if (0) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)195, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
    nrf_block_dev_sdc_work_t * p_work = p_sdc_dev->p_work;
...
static ret_code_t block_dev_sdc_read_req(nrf_block_dev_t const * p_blk_dev,
                                         nrf_block_req_t const * p_blk)
{
    if (0) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)239, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    if (0) { if (p_blk) { } else { assert_nrf_callback((uint16_t)240, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
    nrf_block_dev_sdc_work_t * p_work = p_sdc_dev->p_work;
...
static ret_code_t block_dev_sdc_write_req(nrf_block_dev_t const * p_blk_dev,
                                         nrf_block_req_t const * p_blk)
{
    if (0) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)289, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    if (0) { if (p_blk) { } else { assert_nrf_callback((uint16_t)290, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
    nrf_block_dev_sdc_work_t * p_work = p_sdc_dev->p_work;
...
{
    if (0) { if (p_blk_dev) { } else { assert_nrf_callback((uint16_t)374, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\block_dev\\sdc\\nrf_block_dev_sdc.c"); } };
    nrf_block_dev_sdc_t const * p_sdc_dev =
                                (nrf_block_dev_sdc_t *)((char *)p_blk_dev - __builtin_offsetof (nrf_block_dev_sdc_t, block_dev));
