...
.LCFI8:
	...
	ldr	r3, [sp]
	ldrh	r2, [r3]
	.loc 6 205 44 discriminator 1
	ldr	r3, [sp, #4]
	ldrh	r3, [r3, #2]
	.loc 6 204 62 discriminator 1
	cmp	r2, r3
	bne	.L96
	.loc 6 207 42
	ldr	r3, [sp, #4]
...
.LFE225:
	...
	.section	.text.on_user_mem_release,"ax",%progbits
	.align	1
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	on_user_mem_release, %function
on_user_mem_release:
.LFB226:
	.loc 6 220 1
	@ args = 0, pretend = 0, frame = 8
...
.LCFI11:
	...
	bx	lr
.LFE226:
	.size	on_user_mem_release, .-on_user_mem_release
...
.LCFI13:
	...
	cmp	r3, #4
	beq	.L102
	.loc 6 400 35 discriminator 1
	ldr	r3, [sp, #28]
	ldrb	r3, [r3, #8]	@ zero_extendqisi2
	.loc 6 399 48 discriminator 1
	cmp	r3, #6
	beq	.L102
	.loc 6 401 35
	ldr	r3, [sp, #28]
