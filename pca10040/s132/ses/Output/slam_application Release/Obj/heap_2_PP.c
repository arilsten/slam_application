...
# 39 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c" 2
...
static size_t xFreeBytesRemaining = ( (14000 ) - 8 );
# 119 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c"
...
void *pvReturn = 
# 123 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c" 3 4
                0
# 123 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c"
                    ;
 ...
 vTaskSuspendAll();
 {
  ...
  if( ( xWantedSize > 0 ) && ( xWantedSize < ( (14000 ) - 8 ) ) )
  {
...
# 155 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c"
  ...
  if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) prvTraceStoreEvent2(0x38, (uint32_t)pvReturn, xWantedSize);;
 }
 ( void ) xTaskResumeAll();
# 207 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c"
 return pvReturn;
...
# 216 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c"
               )
 {
  ...
  vTaskSuspendAll();
  {
   ...
   if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) prvTraceStoreEvent2(0x39, (uint32_t)pv, (uint32_t)(0 - pxLink->xBlockSize));;
  }
  ( void ) xTaskResumeAll();
 }
}
...
# 265 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_2.c"
 ...
 pxFirstFreeBlock->xBlockSize = ( (14000 ) - 8 );
