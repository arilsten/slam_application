...
BaseType_t xSwitchRequired = ( ( BaseType_t ) 0 );
 ...
 if (uxSchedulerSuspended == ( unsigned long ) ( ( BaseType_t ) 1 ) || uxPendedTicks == 0) { extern uint32_t uiTraceTickCount; uiTraceTickCount++; } if (uxSchedulerSuspended == (unsigned long) ( ( BaseType_t ) 0 )) { prvTraceStoreEvent1(0x31, (uint32_t)(xTickCount + 1)); };
 if( uxSchedulerSuspended == ( UBaseType_t ) ( ( BaseType_t ) 0 ) )
 {
 ...
 uint32_t ulReturn;
  ...
  vPortEnterCritical();
  {
   ...
   if( pxCurrentTCB->ulNotifiedValue == 0UL )
   {
    ...
    {
     prvAddCurrentTaskToDelayedList( xTicksToWait, ( ( BaseType_t ) 1 ) );
     if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) prvTraceStoreEvent2(0xCB, (uint32_t)pxCurrentTCB, xTicksToWait);;
 ...
 BaseType_t xReturn;
  ...
  vPortEnterCritical();
  {
   ...
   if( pxCurrentTCB->ucNotifyState != ( ( uint8_t ) 2 ) )
   {
    ...
    {
     prvAddCurrentTaskToDelayedList( xTicksToWait, ( ( BaseType_t ) 1 ) );
     if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) prvTraceStoreEvent2(0xCE, (uint32_t)pxCurrentTCB, xTicksToWait);;
