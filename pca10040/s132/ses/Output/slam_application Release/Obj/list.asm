...
.L48:
	...
	b	.L50
.L51:
	.loc 2 151 125 discriminator 3
	ldr	r3, [sp, #12]
	ldr	r3, [r3, #4]
	str	r3, [sp, #12]
.L50:
	.loc 2 151 71 discriminator 1
	ldr	r3, [sp, #12]
	ldr	r3, [r3, #4]
	.loc 2 151 79 discriminator 1
	ldr	r3, [r3]
...
.LEFDE94:
	.text
.Letext0:
	.file 3 "../../../../../../external/freertos/source/include/list.h"
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x2
	.file 14 "C:/Program Files (x86)/SEGGER/SEGGER Embedded Studio for ARM 4.50/include/stdlib.h"
	.byte	0x3
	.uleb128 0x1e
	.uleb128 0xe
	.byte	0x3
