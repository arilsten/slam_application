...
{
    if (0) { if (channel < 8) { } else { assert_nrf_callback((uint16_t)480, (uint8_t *)"../../../../../../modules/nrfx/hal/nrf_saadc.h"); } };
...
nrfx_err_t nrfx_saadc_init(nrfx_saadc_config_t const * p_config,
                           nrfx_saadc_event_handler_t event_handler)
{
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)214, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if (event_handler) { } else { assert_nrf_callback((uint16_t)215, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    nrfx_err_t err_code;
...
void nrfx_saadc_uninit(void)
{
    if (0) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)260, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
...
# 268 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"
   ; break; } nrfx_coredep_delay_us(0); } while (--remaining_attempts); } while(0);
    if (0) { if (result) { } else { assert_nrf_callback((uint16_t)269, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    ...
    for (uint32_t channel = 0; channel < 8; ++channel)
    {
        if (m_cb.psel[channel].pselp != NRF_SAADC_INPUT_DISABLED)
        {
            ...
            if (0) { if (err_code == ((0x0) + 0)) { } else { assert_nrf_callback((uint16_t)279, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
        }
    }
...
nrfx_err_t nrfx_saadc_channel_init(uint8_t channel,
                                   nrf_saadc_channel_config_t const * const p_config)
{
    if (0) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)290, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if (channel < 8) { } else { assert_nrf_callback((uint16_t)291, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };

    if (0) { if ((nrf_saadc_oversample_get() == NRF_SAADC_OVERSAMPLE_DISABLED) || (m_cb.active_channels == 0)) { } else { assert_nrf_callback((uint16_t)293, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } }
                                            ;
    if (0) { if ((p_config->pin_p <= NRF_SAADC_INPUT_VDD) && (p_config->pin_p > NRF_SAADC_INPUT_DISABLED)) { } else { assert_nrf_callback((uint16_t)295, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } }
                                                             ;
    if (0) { if (p_config->pin_n <= NRF_SAADC_INPUT_VDD) { } else { assert_nrf_callback((uint16_t)297, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
...
nrfx_err_t nrfx_saadc_channel_uninit(uint8_t channel)
{
    if (0) { if (channel < 8) { } else { assert_nrf_callback((uint16_t)345, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)346, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
...
# 410 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"
   ; break; } nrfx_coredep_delay_us(0); } while (--remaining_attempts); } while(0);
    if (0) { if (result) { } else { assert_nrf_callback((uint16_t)411, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
...
{
    if (0) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)447, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if ((size % m_cb.active_channels) == 0) { } else { assert_nrf_callback((uint16_t)448, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    nrfx_err_t err_code;
...
{
    if (0) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)522, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
...
{
    if (0) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)545, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
...
# 593 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"
           ; break; } nrfx_coredep_delay_us(0); } while (--remaining_attempts); } while(0);
            if (0) { if (result) { } else { assert_nrf_callback((uint16_t)594, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
        }
...
void nrfx_saadc_limits_set(uint8_t channel, int16_t limit_low, int16_t limit_high)
{
    if (0) { if (m_cb.state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)608, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if (m_cb.event_handler) { } else { assert_nrf_callback((uint16_t)609, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if (limit_low >= (-2048)) { } else { assert_nrf_callback((uint16_t)610, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if (limit_high <= (2047)) { } else { assert_nrf_callback((uint16_t)611, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
    if (0) { if (limit_low < limit_high) { } else { assert_nrf_callback((uint16_t)612, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\nrfx_saadc.c"); } };
