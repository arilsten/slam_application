...
.L46:
	...
	ldr	r3, [sp, #4]
	add	r2, r2, r3
	.loc 2 97 38 discriminator 1
	ldr	r3, .L50+8
	ldr	r3, [r3]
	.loc 2 96 62 discriminator 1
	cmp	r2, r3
	bls	.L47
	.loc 2 101 30
	ldr	r3, .L50
...
.LFE203:
	...
	.section	.bss.pucAlignedHeap.9045,"aw",%nobits
	.align	2
	.type	pucAlignedHeap.9045, %object
	.size	pucAlignedHeap.9045, 4
pucAlignedHeap.9045:
	.space	4
...
.Letext0:
	...
	.4byte	.LASF108
	.byte	0
	.file 7 "C:/Program Files (x86)/SEGGER/SEGGER Embedded Studio for ARM 4.50/include/stdlib.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x1e
	.byte	0x4
	.file 36 "../../../TraceRecorder/include/trcRecorder.h"
	.byte	0x3
	.uleb128 0xd4
	.uleb128 0x24
	.file 37 "C:/Program Files (x86)/SEGGER/SEGGER Embedded Studio for ARM 4.50/include/stdarg.h"
	.byte	0x3
	.uleb128 0x34
	.uleb128 0x25
	.byte	0x4
	.file 38 "../../../config/trcConfig.h"
	.byte	0x3
	.uleb128 0x36
	.uleb128 0x26
	.file 39 "../../../TraceRecorder/include/trcPortDefines.h"
	.byte	0x3
	.uleb128 0x37
	.uleb128 0x27
	.byte	0x4
	...
	.uleb128 0x11
	.byte	0x4
	.file 40 "../../../config/trcStreamingConfig.h"
	.byte	0x3
	.uleb128 0x127
	.uleb128 0x28
	.byte	0x4
	...
	.uleb128 0x27
	.byte	0x4
	.file 41 "../../../TraceRecorder/include/trcHardwarePort.h"
	.byte	0x3
	.uleb128 0x4f
	.uleb128 0x29
	.byte	0x4
	.file 42 "../../../TraceRecorder/streamports/Jlink_RTT/include/trcStreamingPort.h"
	.byte	0x3
	.uleb128 0x50
	.uleb128 0x2a
	.file 43 "../../../TraceRecorder/streamports/Jlink_RTT/include/SEGGER_RTT_Conf.h"
	.byte	0x3
	.uleb128 0x85
	.uleb128 0x2b
	.byte	0x4
...
.LASF290:
	...
	.ascii	"urce\\portable\\MemMang\\heap_1.c\000"
.LASF227:
	.ascii	"sd_radio_notification_cfg_set\000"
.LASF165:
	.ascii	"long long int\000"
