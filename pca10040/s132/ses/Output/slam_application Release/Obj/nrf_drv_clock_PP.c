...
{
# 121 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    if (0) { if (!nrf_sdh_is_enabled()) { } else { assert_nrf_callback((uint16_t)121, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
void nrf_drv_clock_uninit(void)
{
    if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)197, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    nrfx_clock_disable();
    nrfx_clock_uninit();
}
...
void nrf_drv_clock_lfclk_request(nrf_drv_clock_handler_item_t * p_handler_item)
{
    if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)231, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    ...
    if (0) { if (m_clock_cb.lfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)259, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
}

void nrf_drv_clock_lfclk_release(void)
{
    if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)264, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    if (0) { if (m_clock_cb.lfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)265, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
# 276 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    nrf_drv_clock_lfclk_is_running(void)
{
    if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)278, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
void nrf_drv_clock_hfclk_request(nrf_drv_clock_handler_item_t * p_handler_item)
{
    if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)292, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    ...
    if (0) { if (m_clock_cb.hfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)320, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
}

void nrf_drv_clock_hfclk_release(void)
{
    if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)325, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
    if (0) { if (m_clock_cb.hfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)326, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
# 337 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
    nrf_drv_clock_hfclk_is_running(void)
{
    if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)339, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
...
# 573 "C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"
        ...
        case NRF_SDH_EVT_STATE_DISABLED:
            ...
            if (0) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)579, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\integration\\nrfx\\legacy\\nrf_drv_clock.c"); } };
            nrfx_clock_enable();
