...
.LCFI0:
	...
	cmp	r3, #0
	beq	.L2
	.loc 1 48 14 is_stmt 0 discriminator 1
	ldr	r3, [sp, #4]
	ldrh	r3, [r3]
	b	.L3
.L2:
	.loc 1 48 14 discriminator 2
	movw	r3, #65535
.L3:
	.loc 1 48 14 discriminator 4
	strh	r3, [sp, #22]	@ movhi
.LBB2:
	.loc 1 50 19 is_stmt 1 discriminator 4
	movs	r3, #0
	str	r3, [sp, #16]
	.loc 1 50 5 discriminator 4
	b	.L4
.L5:
	.loc 1 52 15 discriminator 3
	ldrh	r3, [sp, #22]
	lsrs	r3, r3, #8
	uxth	r3, r3
	uxtb	r3, r3
	sxth	r2, r3
	.loc 1 52 42 discriminator 3
	ldrh	r3, [sp, #22]
	lsls	r3, r3, #8
	.loc 1 52 35 discriminator 3
	sxth	r3, r3
	orrs	r3, r3, r2
	sxth	r3, r3
