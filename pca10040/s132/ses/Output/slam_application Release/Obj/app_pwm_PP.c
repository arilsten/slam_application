                                          ...
                                          uint16_t ticks)
{
    ...
    if (0) { if (channel < 2) { } else { assert_nrf_callback((uint16_t)603, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
    if (0) { if (p_ch_cb->initialized == 1) { } else { assert_nrf_callback((uint16_t)604, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
...
{
    if (0) { if (channel < 2) { } else { assert_nrf_callback((uint16_t)684, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
    app_pwm_cb_t * p_cb = p_instance->p_cb;
...
ret_code_t app_pwm_init(app_pwm_t const * const p_instance, app_pwm_config_t const * const p_config,
                        app_pwm_callback_t p_ready_callback)
{
    if (0) { if (p_instance) { } else { assert_nrf_callback((uint16_t)785, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
...
void app_pwm_enable(app_pwm_t const * const p_instance)
{
    ...
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)919, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
...
void app_pwm_disable(app_pwm_t const * const p_instance)
{
    ...
    if (0) { if (p_cb->state != NRFX_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)948, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\pwm\\app_pwm.c"); } };
