                              ...
                              nrf_block_dev_event_t const * p_event)
{
    ...
    if (0) { if (drv < m_drives_count) { } else { assert_nrf_callback((uint16_t)63, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DSTATUS disk_initialize(BYTE drv)
{
    if (0) { if (m_drives) { } else { assert_nrf_callback((uint16_t)89, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DSTATUS disk_uninitialize(BYTE drv)
{
    if (0) { if (m_drives) { } else { assert_nrf_callback((uint16_t)134, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DSTATUS disk_status(BYTE drv)
{
    if (0) { if (m_drives) { } else { assert_nrf_callback((uint16_t)179, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DRESULT disk_read(BYTE drv, BYTE *buff, DWORD sector, UINT count)
{
    if (0) { if (m_drives) { } else { assert_nrf_callback((uint16_t)190, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DRESULT disk_write(BYTE drv, const BYTE *buff, DWORD sector, UINT count)
{
    if (0) { if (m_drives) { } else { assert_nrf_callback((uint16_t)229, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
DRESULT disk_ioctl(BYTE drv, BYTE cmd, void *buff)
{
    if (0) { if (m_drives) { } else { assert_nrf_callback((uint16_t)272, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
...
void diskio_blockdev_register(diskio_blkdev_t * diskio_blkdevs, size_t count)
{
    if (0) { if (diskio_blkdevs) { } else { assert_nrf_callback((uint16_t)328, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\external\\fatfs\\port\\diskio_blkdev.c"); } };
