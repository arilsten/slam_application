...
.L46:
	...
	cmp	r3, #0
	beq	.L45
	.loc 2 173 45 discriminator 1
	ldr	r3, .L54+4
	ldr	r3, [r3]
	.loc 2 173 28 discriminator 1
	ldr	r2, [sp, #4]
	cmp	r2, r3
	bhi	.L45
	.loc 2 177 21
...
.L47:
	...
	cmp	r2, r3
	bls	.L48
	.loc 2 179 62 discriminator 1
	ldr	r3, [sp, #20]
	ldr	r3, [r3]
	.loc 2 179 50 discriminator 1
	cmp	r3, #0
	bne	.L49
.L48:
	.loc 2 187 17
...
.LCFI4:
	...
	ldr	r1, [sp, #4]
	.loc 2 303 159 discriminator 1
	ldr	r3, [sp, #8]
	ldr	r3, [r3, #4]
	.loc 2 303 151 discriminator 1
	rsbs	r3, r3, #0
	.loc 2 303 98 discriminator 1
	mov	r2, r3
	movs	r0, #57
...
.LCFI6:
	...
	b	.L71
.L72:
	.loc 2 340 87 discriminator 3
	ldr	r3, [sp, #12]
	ldr	r3, [r3]
	str	r3, [sp, #12]
.L71:
	.loc 2 340 39 discriminator 1
	ldr	r3, [sp, #12]
	ldr	r3, [r3]
	.loc 2 340 2 discriminator 1
	ldr	r2, [sp, #4]
	cmp	r2, r3
	bhi	.L72
	.loc 2 347 6
...
.Letext0:
	...
	.4byte	.LASF4
	.byte	0
	.file 4 "../../../../../../external/freertos/source/include/portable.h"
	.file 5 "C:/Program Files (x86)/SEGGER/SEGGER Embedded Studio for ARM 4.50/include/stdint.h"
	.section	.debug_types,"G",%progbits,wt.625690b74770733e,comdat
	.4byte	0x6e
	.2byte	0x4
	.4byte	.Ldebug_abbrev0
	.byte	0x4
...
.LASF323:
	...
	.ascii	"urce\\portable\\MemMang\\heap_5.c\000"
.LASF187:
	.ascii	"timeval\000"
.LASF260:
	.ascii	"distance\000"
