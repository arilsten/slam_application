...
# 2 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\ControllerTask.c" 2
...
# 52 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\ControllerTask.c" 3 4
...
void motorRegulator(int16_t lspeed, int16_t rspeed, encoderTicks ticks) {
   ...
   if (1 && (3 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "speed PID L: %d R:%d", (uint32_t)((int)Lspeed), (uint32_t)((int)Rspeed)); } };
    if (Lspeed > 100) {
        Lspeed = 100;
    }
    if (Lspeed < -100) {
