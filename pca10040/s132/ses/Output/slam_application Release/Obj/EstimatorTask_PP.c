...
# 2 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\EstimatorTask.c" 2
...
void microsd_task();
# 12 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\EstimatorTask.c" 2
# 1 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\kalmanFilter.h" 1
...
# 49 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\EstimatorTask.c"
   ...
   TickType_t xLastWakeTime2 = xLastWakeTime;
    ...
    kf_init(7,8);
    while (
# 56 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\EstimatorTask.c" 3 4
          1
# 56 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\EstimatorTask.c"
              ) {
...
# 70 "C:\\nRF5_SDK_15.0.0_a53641a\\examples\\ble_peripheral\\slam_applicationLeithe\\software\\EstimatorTask.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
            ...
            if (IMU_newData()) {
                ...
                if (1 && (3 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (NRF_LOG_SEVERITY_DEBUG >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_INFO) | m_nrf_log_app_logs_data_dynamic.module_id << 16), "ACC X:%d ,Y:%d, Z:%d", (uint32_t)((int)(accel.x*10000)), (uint32_t)((int)(accel.y*10000)), (uint32_t)((int)(accel.z*10000))); } };
            } else {
