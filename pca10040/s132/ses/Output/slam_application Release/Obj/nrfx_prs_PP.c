...
0 
# 81 "C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"
}; void UARTE0_UART0_IRQHandler(void) { if (0) { if (m_prs_box_4.handler) { } else { assert_nrf_callback((uint16_t)81, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"); } }; m_prs_box_4.handler(); }
...
nrfx_err_t nrfx_prs_acquire(void const * p_base_addr,
                            nrfx_irq_handler_t irq_handler)
{
    if (0) { if (p_base_addr) { } else { assert_nrf_callback((uint16_t)119, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"); } };
...
void nrfx_prs_release(void const * p_base_addr)
{
    if (0) { if (p_base_addr) { } else { assert_nrf_callback((uint16_t)155, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"); } };
