...
# 253 "C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"
    ...
    if (0) { if (p_pool->p_cb) { } else { assert_nrf_callback((uint16_t)255, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (0) { if (p_pool->p_stack_base) { } else { assert_nrf_callback((uint16_t)256, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (0) { if (p_pool->p_stack_limit) { } else { assert_nrf_callback((uint16_t)257, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (0) { if (p_pool->p_memory_begin) { } else { assert_nrf_callback((uint16_t)258, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
    if (0) { if (p_pool->block_size) { } else { assert_nrf_callback((uint16_t)259, (uint8_t *)"C:\\nRF5_SDK_15.0.0_a53641a\\components\\libraries\\balloc\\nrf_balloc.c"); } };
