...
.L127:
	.align	2
.L126:
	.word	m_conn_state_user_flag_id
	.word	m_connections
.LFE279:
...
.LBB3:
	...
	b	.L129
.L130:
	.loc 7 111 23 discriminator 3
	ldr	r2, .L131
	ldr	r3, [sp, #12]
	ldr	r3, [r2, r3, lsl #2]
	.loc 7 111 9 discriminator 3
	ldr	r0, [sp, #4]
	blx	r3
.LVL0:
	.loc 7 109 85 discriminator 3
	ldr	r3, [sp, #12]
	adds	r3, r3, #1
	str	r3, [sp, #12]
.L129:
	.loc 7 109 5 discriminator 1
	ldr	r3, [sp, #12]
	cmp	r3, #1
	bls	.L130
.LBE3:
...
.L137:
	...
	b	.L136
.L135:
	.loc 7 126 37 discriminator 2
	ldr	r3, [sp, #4]
	adds	r3, r3, #1
	str	r3, [sp, #4]
.L134:
	.loc 7 126 5 discriminator 1
	ldr	r3, [sp, #4]
	cmp	r3, #19
	bls	.L137
.LBE4:
...
.L145:
	...
	b	.L144
.L143:
	.loc 7 151 41 discriminator 2
	ldr	r3, [sp, #12]
	adds	r3, r3, #1
	str	r3, [sp, #12]
.L142:
	.loc 7 151 9 discriminator 1
	ldr	r3, [sp, #12]
	cmp	r3, #19
	bls	.L145
.L141:
...
.L158:
	...
	b	.L157
.L156:
	.loc 7 210 35 discriminator 2
	ldr	r3, [sp, #12]
	adds	r3, r3, #1
	str	r3, [sp, #12]
.L155:
	.loc 7 210 5 discriminator 1
	ldr	r3, [sp, #12]
	cmp	r3, #15
	bls	.L158
.LBE6:
...
.LCFI23:
	...
	cmp	r3, #0
	beq	.L183
	.loc 7 356 30 discriminator 3
	ldr	r3, [sp]
	adds	r3, r3, #1
	mov	r0, r3
	bl	is_valid_irk
	mov	r3, r0
	.loc 7 356 27 discriminator 3
	cmp	r3, #0
	beq	.L183
	.loc 7 356 27 is_stmt 0 discriminator 2
	movs	r3, #1
	b	.L184
.L183:
	.loc 7 356 27 discriminator 1
	movs	r3, #0
.L184:
	.loc 7 352 9 is_stmt 1
	strb	r3, [sp, #15]
	ldrb	r3, [sp, #15]
	and	r3, r3, #1
	strb	r3, [sp, #15]
	...
	cmp	r3, #4
	beq	.L185
	.loc 7 363 44 discriminator 3
	ldr	r3, [sp, #16]
	ldrb	r3, [r3]	@ zero_extendqisi2
	bic	r3, r3, #1
	uxtb	r3, r3
	.loc 7 363 21 discriminator 3
	cmp	r3, #6
	beq	.L185
	.loc 7 363 21 is_stmt 0 discriminator 2
	movs	r3, #1
	b	.L186
.L185:
	.loc 7 363 21 discriminator 1
	movs	r3, #0
.L186:
	.loc 7 360 9 is_stmt 1
	strb	r3, [sp, #13]
	ldrb	r3, [sp, #13]
	and	r3, r3, #1
	strb	r3, [sp, #13]
	...
	cmp	r3, #0
	beq	.L187
	.loc 7 365 28 discriminator 1
	ldrb	r3, [sp, #13]	@ zero_extendqisi2
	cmp	r3, #0
	bne	.L188
.L187:
	.loc 7 365 41 discriminator 4
	ldrb	r3, [sp, #15]	@ zero_extendqisi2
	cmp	r3, #0
	beq	.L189
	.loc 7 365 62 discriminator 5
	ldrb	r3, [sp, #13]
	eor	r3, r3, #1
	uxtb	r3, r3
	.loc 7 365 59 discriminator 5
	cmp	r3, #0
	beq	.L189
.L188:
	.loc 7 365 41 discriminator 7
	movs	r3, #1
	b	.L190
.L189:
	.loc 7 365 41 is_stmt 0 discriminator 8
	movs	r3, #0
.L190:
	.loc 7 365 41 discriminator 10
	and	r3, r3, #1
	uxtb	r3, r3
	.loc 7 366 1 is_stmt 1 discriminator 10
	mov	r0, r3
	add	sp, sp, #28
.LCFI24:
	@ sp needed
...
.L220:
	...
	cmp	r3, #0
	bne	.L218
	.loc 7 481 58 discriminator 1
	ldr	r3, [sp, #16]
	.loc 7 481 13 discriminator 1
	adds	r3, r3, #42
	mov	r1, r3
	ldr	r0, [sp, #4]
	bl	im_master_ids_compare
	mov	r3, r0
	.loc 7 480 94 discriminator 1
	cmp	r3, #0
	beq	.L217
.L218:
	.loc 7 484 20
...
.L226:
	...
	b	.L225
.L224:
	.loc 7 497 37 discriminator 2
	ldr	r3, [sp, #12]
	adds	r3, r3, #1
	str	r3, [sp, #12]
.L223:
	.loc 7 497 5 discriminator 1
	ldr	r3, [sp, #12]
	cmp	r3, #19
	bls	.L226
.LBE9:
...
.L234:
	...
	b	.L231
.L233:
	.loc 7 517 34 discriminator 2
	ldr	r3, [sp, #12]
	adds	r3, r3, #1
	str	r3, [sp, #12]
.L232:
	.loc 7 517 5 discriminator 1
	ldr	r3, [sp, #12]
	cmp	r3, #7
	bls	.L234
.LBE10:
...
.L256:
.LBE12:
	.loc 7 614 41 discriminator 2
	ldr	r3, [sp, #120]
	adds	r3, r3, #1
	str	r3, [sp, #120]
.L250:
	.loc 7 614 5 discriminator 1
	ldr	r2, [sp, #120]
	ldr	r3, [sp, #8]
	cmp	r2, r3
	bcc	.L257
...
.L265:
	...
	subs	r3, r3, r2
	add	r1, r1, r3
	.loc 7 678 21 discriminator 3
	add	r3, sp, #16
	ldr	r2, [sp, #332]
	str	r1, [r3, r2, lsl #2]
	.loc 7 676 36 discriminator 3
	ldr	r3, [sp, #332]
	adds	r3, r3, #1
	str	r3, [sp, #332]
.L264:
	.loc 7 676 5 discriminator 1
	ldr	r3, [sp, #332]
	cmp	r3, #7
	bls	.L265
.LBE13:
...
.L269:
	...
	bl	memcpy
.LBE15:
	.loc 7 681 41 discriminator 2
	ldr	r3, [sp, #328]
	adds	r3, r3, #1
	str	r3, [sp, #328]
.L266:
	.loc 7 681 5 discriminator 1
	mov	r3, sp
	ldr	r2, [sp, #328]
	ldr	r3, [r3]
	cmp	r2, r3
...
.L292:
	...
	cmp	r3, #0
	beq	.L287
	.loc 7 750 53 discriminator 1
	ldr	r3, .L293
	ldrb	r3, [r3]	@ zero_extendqisi2
	mov	r2, r3
	.loc 7 750 55 discriminator 1
	ldr	r3, [sp, #16]
	ldr	r3, [r3]
	.loc 7 750 30 discriminator 1
	cmp	r2, r3
	bhi	.L288
.L287:
	.loc 7 750 69 discriminator 3
	ldr	r3, [sp, #8]
	cmp	r3, #0
	beq	.L289
	.loc 7 751 53
...
.L294:
	.align	2
.L293:
	.word	m_wlisted_peer_cnt
	.word	m_wlisted_peers
.LFE305:
...
.L301:
	...
	subs	r3, r3, r2
	adds	r2, r1, r3
	.loc 7 813 22 discriminator 3
	ldr	r3, [sp, #116]
	lsls	r3, r3, #2
	add	r1, sp, #120
	add	r3, r3, r1
	str	r2, [r3, #-44]
	.loc 7 811 36 discriminator 3
	ldr	r3, [sp, #116]
	adds	r3, r3, #1
	str	r3, [sp, #116]
.L300:
	.loc 7 811 5 discriminator 1
	ldr	r3, [sp, #116]
	cmp	r3, #7
	bls	.L301
.LBE16:
...
.LBB17:
	...
	b	.L306
.L307:
	.loc 7 851 44 discriminator 3
	ldr	r3, [sp, #76]
	rsb	r3, r3, #15
	.loc 7 851 34 discriminator 3
	ldr	r2, [sp, #12]
	add	r3, r3, r2
	ldrb	r1, [r3]	@ zero_extendqisi2
	.loc 7 851 29 discriminator 3
	add	r2, sp, #20
	ldr	r3, [sp, #76]
	add	r3, r3, r2
	mov	r2, r1
	strb	r2, [r3]
	.loc 7 849 37 discriminator 3
	ldr	r3, [sp, #76]
	adds	r3, r3, #1
	str	r3, [sp, #76]
.L306:
	.loc 7 849 5 discriminator 1
	ldr	r3, [sp, #76]
	cmp	r3, #15
	bls	.L307
.LBE17:
...
.LBB18:
	...
	b	.L308
.L309:
	.loc 7 858 51 discriminator 3
	ldr	r2, [sp, #8]
	ldr	r3, [sp, #72]
	add	r2, r2, r3
	.loc 7 858 41 discriminator 3
	ldr	r3, [sp, #72]
	rsb	r3, r3, #15
	.loc 7 858 51 discriminator 3
	ldrb	r2, [r2]	@ zero_extendqisi2
	.loc 7 858 46 discriminator 3
	add	r1, sp, #80
	add	r3, r3, r1
	strb	r2, [r3, #-44]
	.loc 7 856 36 discriminator 3
	ldr	r3, [sp, #72]
	adds	r3, r3, #1
	str	r3, [sp, #72]
.L308:
	.loc 7 856 5 discriminator 1
	ldr	r3, [sp, #72]
	cmp	r3, #2
	bls	.L309
.LBE18:
...
.LBB19:
	...
	b	.L310
.L311:
	.loc 7 866 60 discriminator 3
	ldr	r3, [sp, #68]
	rsb	r2, r3, #15
	.loc 7 866 21 discriminator 3
	ldr	r1, [sp, #4]
	ldr	r3, [sp, #68]
	add	r3, r3, r1
	.loc 7 866 50 discriminator 3
	add	r1, sp, #80
	add	r2, r2, r1
	ldrb	r2, [r2, #-28]	@ zero_extendqisi2
	.loc 7 866 25 discriminator 3
	strb	r2, [r3]
	.loc 7 864 36 discriminator 3
	ldr	r3, [sp, #68]
	adds	r3, r3, #1
	str	r3, [sp, #68]
.L310:
	.loc 7 864 5 discriminator 1
	ldr	r3, [sp, #68]
	cmp	r3, #2
	bls	.L311
.LBE19:
...
.Letext0:
	...
	.4byte	.LASF6
	.byte	0
	.file 10 "../../../../../../components/ble/common/ble_conn_state.h"
