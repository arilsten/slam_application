...
# 42 "C:\\nRF5_SDK_15.0.0_a53641a\\external\\freertos\\source\\portable\\MemMang\\heap_3.c" 2
...
void vPortFree( void *pv )
{
 if( pv )
 {
  ...
  {
   free( pv );
   if (prvTraceGetTaskNumberHigh16((void*)prvTraceGetCurrentTaskHandle()) & CurrentFilterMask) prvTraceStoreEvent2(0x39, (uint32_t)pv, (uint32_t)(0 - 0));;
  }
  ( void ) xTaskResumeAll();
 }
}
